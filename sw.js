...
self.addEventListener("fetch", function(e){
  ...
  // api.github.com is cross-origin so it never reaches here, but be explicit:
  // sync traffic must never be served from a cache.
  if(url.pathname.indexOf("/repos/") === 0) return;
